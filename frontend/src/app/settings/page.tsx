  ...
  return (
    <div className="p-8 max-w-[1024px] mx-auto space-y-8 flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm">
        <div className="p-6 flex flex-col md:flex-row gap-6 items-center md:items-start">
          ...
          <div className="relative">
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-xl bg-surface-container flex items-center justify-center overflow-hidden border-2 border-primary/10 relative">
              <Image
            ...
            <Link
              ...
              className="absolute -bottom-2 -right-2 bg-primary text-on-primary p-2 rounded-full shadow-lg active:scale-95 transition-transform inline-flex"
            >
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-surface-container-lowest p-3 border border-outline-variant rounded-lg shadow-sm">
                <p className="text-label-md text-on-surface-variant mb-1 font-bold text-xs uppercase">
                  Tax ID
                </p>
                <p className="font-mono-data text-on-surface text-sm font-bold">{taxId}</p>
              </div>
              <div className="bg-surface-container-lowest p-3 border border-outline-variant rounded-lg shadow-sm">
                <p className="text-label-md text-on-surface-variant mb-1 font-bold text-xs uppercase">
                  Primary Email
                </p>
                <p className="font-mono-data text-on-surface text-sm font-bold truncate">{email}</p>
              </div>
              <div className="bg-surface-container-lowest p-3 border border-outline-variant rounded-lg shadow-sm">
                <p className="text-label-md text-on-surface-variant mb-1 font-bold text-xs uppercase">
                  Fiscal Year
                </p>
                <p className="font-mono-data text-on-surface text-sm font-bold">Jan - Dec</p>
              </div>
            </div>
          </div>
        </div>

        <div className="bg-surface-container-low px-6 py-3 border-t border-outline-variant flex justify-end">
          <Link
            href="/settings/organization"
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <Link
          href="/users"
          className="flex items-center text-left p-4 bg-surface border border-outline-variant rounded-xl hover:bg-surface-container-low transition-all active:scale-[0.99] group shadow-sm"
        >
          <div className="w-12 h-12 flex-shrink-0 bg-secondary-fixed rounded-lg flex items-center justify-center text-on-secondary-fixed mr-4 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-[24px]">person</span>
          </div>
          <div className="flex-1">
            <h3 className="font-semibold text-body-lg text-on-surface group-hover:text-primary transition-colors">
        ...
        <button
          ...
          className="flex items-center text-left p-4 bg-surface border border-outline-variant rounded-xl hover:bg-surface-container-low transition-all active:scale-[0.99] group shadow-sm"
        >
          <div className="w-12 h-12 flex-shrink-0 bg-primary-fixed rounded-lg flex items-center justify-center text-on-primary-fixed mr-4 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-[24px]">palette</span>
          </div>
          <div className="flex-1">
            <h3 className="font-semibold text-body-lg text-on-surface">Invoice Templates</h3>
            <p className="text-body-sm text-on-surface-variant">
        ...
        <button
          ...
          className="flex items-center text-left p-4 bg-surface border border-outline-variant rounded-xl hover:bg-surface-container-low transition-all active:scale-[0.99] group shadow-sm"
        >
          <div className="w-12 h-12 flex-shrink-0 bg-surface-container-highest rounded-lg flex items-center justify-center text-primary mr-4 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-[24px]">mail</span>
          </div>
          <div className="flex-1">
            <h3 className="font-semibold text-body-lg text-on-surface">Email Notifications</h3>
            <p className="text-body-sm text-on-surface-variant">
        ...
        <button
          ...
          className="flex items-center text-left p-4 bg-surface border border-outline-variant rounded-xl hover:bg-surface-container-low transition-all active:scale-[0.99] group shadow-sm"
        >
          <div className="w-12 h-12 flex-shrink-0 bg-error-container rounded-lg flex items-center justify-center text-error mr-4 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-[24px]">history_edu</span>
          </div>
          <div className="flex-1">
            <h3 className="font-semibold text-body-lg text-on-surface">Audit Logs</h3>
            <p className="text-body-sm text-on-surface-variant">
      ...
      <div className="pt-6 border-t border-outline-variant">
        <div className="bg-error-container/20 border border-error/20 p-5 rounded-xl flex items-center justify-between shadow-sm">
          <div>
            <h4 className="font-semibold text-body-md text-error font-bold">
          ...
          <button
            ...
            className="px-4 py-2 bg-white border border-error/30 text-error font-semibold text-label-md rounded-lg hover:bg-error-container/30 transition-colors text-xs"
          >
            Upgrade Plan
          </button>
        </div>
