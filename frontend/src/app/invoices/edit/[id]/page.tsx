...
export default function EditInvoicePage({ params }: { params: { id: string } }) {
    ...
    if (initialFetchLoading) return <div className="p-10 text-center text-on-surface-variant animate-pulse">Loading Invoice Data...</div>;

    return (
        <div className="p-6 max-w-[1000px] mx-auto space-y-6 pb-24">
            <PageHeader 
                title="Edit Invoice" 
                subtitle="Modify customer, item, and payment details." 
            />
