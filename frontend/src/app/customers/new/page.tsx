...
// ---------------------------------------------------------------------------
// Config — align with the customers list page
// ---------------------------------------------------------------------------
...
export default function NewCustomer() {
  ...
  // Address (now wired to state, was previously discarded)
  ...
  const updateBillingField = (field: keyof AddressFields, value: string) => {
    setBillingAddress((prev) => ({ ...prev, [field]: value }));
  };

  const updateShippingField = (field: keyof AddressFields, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const custom_id = `CUST-${Date.now().toString().slice(-6)}`;
      ...
      if (response.ok && res.success) {
        ...
        setSubmitError(res.message || "Failed to create customer.");
      }
    } catch (error) {
      console.error("Failed to submit", error);
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              type="submit"
              disabled={submitting}
              className="inline-flex items-center gap-1.5 bg-zinc-900 hover:bg-zinc-800 text-white text-[13px] font-medium px-3.5 py-2 rounded-lg transition-colors shadow-sm disabled:opacity-50"
            >
              <Save className="w-4 h-4" />
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateBillingField("attention", e.target.value)}
                          />
                        </div>
                        <div>
                          <Label>Country/Region</Label>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => updateBillingField("street1", e.target.value)}
                          />
                          <textarea
                            className={cn(inputCls, "h-16 resize-none")}
                            placeholder="Street 2"
                            value={billingAddress.street2}
                            onChange={(e) => updateBillingField("street2", e.target.value)}
                          />
                        </div>
                        <div>
                          <Label>City</Label>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateBillingField("pinCode", e.target.value)}
                          />
                        </div>
                        <div>
                          <Label>Phone</Label>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateBillingField("fax", e.target.value)}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateShippingField("attention", e.target.value)}
                          />
                        </div>
                        <div>
                          <Label>Country/Region</Label>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => updateShippingField("street1", e.target.value)}
                          />
                          <textarea
                            className={cn(inputCls, "h-16 resize-none")}
                            placeholder="Street 2"
                            value={shippingAddress.street2}
                            onChange={(e) => updateShippingField("street2", e.target.value)}
                          />
                        </div>
                        <div>
                          <Label>City</Label>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateShippingField("fax", e.target.value)}
                          />
                        </div>
                      </div>
                    </div>
          ...
          <SectionCard title="Documents">
            <div className="border-2 border-dashed border-zinc-200 rounded-xl p-8 text-center hover:bg-zinc-50 transition-colors cursor-pointer relative">
              ...
              <p className="text-[11px] text-amber-600 mt-2">
                Note: file uploads are not yet sent to the server — this needs a dedicated upload endpoint.
              </p>
            </div>
