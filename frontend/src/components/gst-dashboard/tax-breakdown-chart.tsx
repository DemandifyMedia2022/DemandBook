    ...
    <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 rounded bg-card-dim"></div>
            <span>SGST</span>
          </div>
        </div>
      </div>
      <div className="flex items-end gap-6 h-48 px-6 border-b border-border/30 pb-2">
        <div className="flex-1 flex flex-col gap-1 h-full justify-end group cursor-pointer">
          ...
          <div className="bg-card-dim w-full h-[20%] rounded-b-sm group-hover:opacity-80 transition-opacity"></div>
          <p className="text-center text-[10px] mt-2 font-mono-data text-muted-foreground">
            Mar
          </p>
        </div>
        <div className="flex-1 flex flex-col gap-1 h-full justify-end group cursor-pointer">
          ...
          <div className="bg-card-dim w-full h-[28%] rounded-b-sm group-hover:opacity-80 transition-opacity"></div>
          <p className="text-center text-[10px] mt-2 font-mono-data text-muted-foreground">
            Apr
          </p>
        </div>
        <div className="flex-1 flex flex-col gap-1 h-full justify-end group cursor-pointer">
          ...
          <div className="bg-card-dim w-full h-[15%] rounded-b-sm group-hover:opacity-80 transition-opacity"></div>
          <p className="text-center text-[10px] mt-2 font-mono-data text-muted-foreground">
            May
          </p>
        </div>
        <div className="flex-1 flex flex-col gap-1 h-full justify-end group cursor-pointer">
          ...
          <div className="bg-card-dim w-full h-[23%] rounded-b-sm group-hover:opacity-80 transition-opacity"></div>
          <p className="text-center text-[10px] mt-2 font-mono-data text-muted-foreground">
            Jun
          </p>
        </div>
