    ...
    <div className="bg-primary text-primary-foreground rounded-xl p-6 shadow-sm relative overflow-hidden">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full py-2.5 bg-primary/10 text-white border border-white/20 rounded-lg font-bold flex items-center justify-center gap-1.5 hover:bg-white/10 transition-all text-xs"
        >
