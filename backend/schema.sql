...
CREATE TABLE IF NOT EXISTS products (
    ...
    stock INT DEFAULT 0,
    type VARCHAR(50) DEFAULT 'Goods' CHECK (type IN ('Goods', 'Service')),
    ...
    preferred_vendor_id INT REFERENCES clients(id) ON DELETE SET NULL,
    intra_state_tax_rate VARCHAR(50) DEFAULT 'GST18 (18 %)',
    inter_state_tax_rate VARCHAR(50) DEFAULT 'IGST18 (18 %)',
